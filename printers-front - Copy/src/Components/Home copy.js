...
class Home extends React.Component {
    ...
    render() {
        return(
            <Container fluid>
                {/* <Row>
                    <Col className="section01" lg={12}>
                        <h1>PDFeast</h1>
                        <p>Automate Pdf files generation</p>
                        <p>Intuitive drag and drop template creator</p>
                        <p>Generate Pdfs files using an API</p>
                    </Col>
                </Row> */}
                <Row>
                    {/* <Col lg={3}></Col> */}
                        ...
                        <div className="demoPdf demoPdfContainer">
                            <div className="demoPdfHeader">
                                ...
                                <Row className="demoPdf demoPdfTabContainer">
                                    ...
                                    <Col lg={10} className="demoPdfTab"></Col>
                                </Row> */}
