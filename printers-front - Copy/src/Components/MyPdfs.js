...
class MyPdfs extends React.Component {
    constructor(props) {
        ...
        var config = {
            method: 'get',
            url: `http://3.67.198.65/api/pdfs/${this.props.website}`,
            headers: { }
        };
            ...
            return(
                // <Container fluid>
                    <Row>
                        ...
                        <Col lg={10}>
                            <iframe title={this.state.currentPdf} src={"http://localhost/pdf/" + this.props.website + '/' + this.state.currentPdf} style={{width: "98%", height: "100%", border: "none"}}/>
                        </Col>
                    </Row>
                // </Container>
            )
